...
$("#dialog-message").dialog("option","buttons",{close:function(){
$(this).dialog("close");
}});
var _1="<div id=\"html5-detection\"><h1>Your browser doesn't support some of these HTML5 features:</h1>";
_1+="<dl>";
_1+="<dt>Application cache:</dt>"+"<dd> "+Modernizr.applicationcache+"</dd>";
_1+="<dt>SQL storage:</dt>"+"<dd> "+Modernizr.sqlstorage+"</dd>";
_1+="<dt>Local storage:</dt>"+"<dd> "+Modernizr.localstorage+"</dd>";
_1+="</dl>";
_1+="<p><strong>Only Chrome is supported.</strong></p>";
_1+="</div>";
...
include.views("views/article/show","views/article/new","views/article/archive","views/article/init","views/article/init_archive","views/article/comment","views/article/comment_form","views/article/list","views/category/show","views/category/init","views/sidebar/archive","views/sidebar/category","views/sidebar/page","views/sidebar/tag","views/sidebar/status","views/sidebar/search","views/tag/init","views/tag/show","views/search/init");
});
;
...
for(var m=0;m<12;m++){
_a.push({value:(m),text:this.month_names[m]});
}
for(var d=0;d<31;d++){
...
;
include.setPath('jmvc/plugins/view/helpers');
$.extend($.View.Helpers.prototype,{pagination:function(_1,_2){
var _3=parseInt(_2.current_page);
var _4=Math.ceil(parseInt(_2.count)/parseInt(localStorage["limit_article_display"]));
var _5=((_3-1)<1?"":_3-1);
var _6=((_3+1)>_4?"":_3+1);
var _7="";
var _8="";
...
if(_2.search!=undefined){
_7="&amp;q="+_2.search;
}
if(_5!=""){
_8="<span><a href=\""+_1+"&amp;page="+_5+_7+"\">« newer</a></span>";
}
if(_6!=""){
_9="<span><a href=\""+_1+"&amp;page="+_6+_7+"\">older »</a></span>";
}
if(_8==""&&_9==""){
return "";
}else{
return "<div class=\"pagination\">"+_8+_9+"</div>";
}
},mark_search_term:function(_a,_b){
var _c=new RegExp(_b,"gi");
$.each(_a,function(i,_e){
_a[i].title=_e.title.replace(_c,function(_f){
return "<mark>"+_f+"</mark>";
});
});
}});
...
_5.open(_3,"/sync/"+_2,false);
if(_3=="POST"){
_4=_1.data.params;
_5.setRequestHeader("Content-type","application/x-www-form-urlencoded");
}
_5.send(_4);
if(_5.status==200&&_3=="GET"){
postMessage([_5.status,eval("("+_5.responseText+")")]);
}else{
postMessage([_5.status,_1]);
}
};
;
include.setPath('resources');
...
;
include.setPath('resources/database');
jQuery.Class.extend("Driver",{},{init:function(_1,_2,_3,_4){
...
},create_tables:function(_5){
var _6=this;
jQuery.each(_5,function(i,_8){
_6.connection.transaction(function(tx){
tx.executeSql(_8);
});
});
...
;
include.setPath('resources/database');
Driver.extend("SqliteDriver",{},{init:function(){
this._super("SqliteTypo","1.0","10485760","Offline database for Typosphere");
},create_tables:function(){
var _1=["CREATE TABLE IF NOT EXISTS contents (id INTEGER PRIMARY KEY, type TEXT, title TEXT, author TEXT, body TEXT, extended TEXT, excerpt TEXT, keywords TEXT, created_at TEXT, updated_at TEXT, user_id INTEGER, permalink TEXT, guid TEXT, text_filter_id INTEGER, whiteboard TEXT, name TEXT, published INTEGER, allow_pings INTEGER, allow_comments INTEGER, published_at TEXT, state TEXT)","CREATE INDEX IF NOT EXISTS index_contents_on_published ON contents (published)","CREATE INDEX IF NOT EXISTS index_contents_on_text_filter_id ON contents (text_filter_id)","CREATE TABLE IF NOT EXISTS categories (id INTEGER PRIMARY KEY, name TEXT, position INTEGER, permalink TEXT, keywords TEXT, description TEXT, parent_id INTEGER)","CREATE INDEX IF NOT EXISTS index_categories_on_permalink ON categories (permalink)","CREATE TABLE IF NOT EXISTS categorizations (id INTEGER PRIMARY KEY, article_id INTEGER, category_id INTEGER, is_primary INTEGER)","CREATE TABLE IF NOT EXISTS tags (id INTEGER PRIMARY KEY, name TEXT, created_at TEXT, updated_at TEXT, display_name TEXT)","CREATE TABLE IF NOT EXISTS articles_tags (article_id INTEGER, tag_id INTEGER)","CREATE TABLE IF NOT EXISTS feedback (id INTEGER PRIMARY KEY, type TEXT, title TEXT, author TEXT, body TEXT, excerpt TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP, user_id INTEGER, guid TEXT, text_filter_id INTEGER, whiteboard TEXT, article_id INTEGER, email TEXT, url TEXT, ip TEXT, blog_name TEXT, published INTEGER, published_at TEXT, state TEXT, status_confirmed INTEGER)","CREATE INDEX IF NOT EXISTS index_feedback_on_article_id ON feedback (article_id)","CREATE INDEX IF NOT EXISTS index_feedback_on_text_filter_id ON feedback (text_filter_id)","CREATE TABLE IF NOT EXISTS sidebars (id INTEGER PRIMARY KEY, active_position INTEGER, config TEXT, staged_position INTEGER, type TEXT)","CREATE TABLE IF NOT EXISTS blogs (id INTEGER PRIMARY KEY, settings TEXT, base_url TEXT)","CREATE TABLE IF NOT EXISTS sync (id INTEGER PRIMARY KEY, table_name TEXT, row_id INTEGER, method TEXT)"];
this._super(_1);
}});
;
include.setPath('resources/database');
jQuery.Class.extend("Creator",{create:function(_1){
}},{});
;
include.setPath('resources/database');
Creator.extend("DatabaseCreator",{create:function(_1){
switch(_1){
case "sqlite":
return new SqliteDriver();
break;
default:
throw new Error("There is no db engine called "+_1);
break;
}
}},{});
;
...
$.Model.extend("MainModel",{parse_result:function(rs){
var _2=new Array;
var _3=new Array;
var _4=new Array;
...
return this.wrapMany(_2);
}},{});
;
include.setPath('models');
MainModel.extend("Article",{init:function(){
this._super();
this.validatesPresenceOf(["title"],{message:"must be supplied"});
this.validatesPresenceOf(["permalink"],{message:"must be supplied"});
},find_all:function(_1,_2,_3){
var _4=this;
var _5=0;
var _6=0;
var _7=0;
...
var _a=new Array;
var _b="";
if(_1.category!=undefined){
_8+=" LEFT JOIN categorizations c2 ON c1.id = c2.article_id LEFT JOIN categories c3 ON c2.category_id = c3.id ";
_9+=" AND (c2.category_id="+_1.category+") ";
}
if(_1.tag!=undefined){
_8+=" INNER JOIN articles_tags a1 ON c1.id = a1.article_id ";
_9+=" AND (a1.tag_id ="+_1.tag+") ";
}
if(_1.date!=undefined){
_9+=" AND (c1.published_at BETWEEN \""+_1.date.year+"-"+_1.date.month+"-1"+" 00:00:00\" AND \""+_1.date.year+"-"+_1.date.month+"-31 23:59:59\") ";
}
if(_1.current_page){
_5=parseInt(_1.current_page);
_6=parseInt(localStorage["limit_article_display"]);
if(isNaN(_6)){
_6=10;
}
_7=(_5<2?_5-1:((_5-1)*_6));
_a=[_6,_7];
_b=" LIMIT ? OFFSET ? ";
}
if(_1.search){
_9+=" AND title like (\"%"+_1.search+"%\")";
console.log(_a);
}
db.transaction(function(tx){
tx.executeSql("SELECT c1 . * "+"FROM contents c1 "+_8+"WHERE (( c1.published=1 ) AND ( c1.type =  'Article' ) "+_9+" ) "+"ORDER BY c1.published_at DESC "+_b,_a,function(tx,rs){
tx.executeSql("SELECT count(*) as count "+"FROM contents c1 "+_8+"WHERE (( c1.published =1 ) AND ( c1.type =  'Article' ) "+_9+" )",[],function(tx,rs2){
_1.count=rs2.rows.item(0).count;
var _11=_4.parse_result(rs);
for(var i=0;i<_11.length;i++){
Category.find_by_article_id(_11[i].id,i,function(_13,_14){
_11[_14].categories=_13;
if(_14==_11.length-1){
return _2(_11,_1);
}
},_3);
...
},find_by_permalink:function(_19,_1a,_1b){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM contents WHERE permalink = ? AND published=1 AND type=\"Article\"",[_19],function(tx,rs){
var _20=obj.parse_result(rs)[0];
Comment.find_by_article_id(_20.id,function(_21){
_20.comments=_21;
Tag.find_by_article_id(_20.id,function(_22){
_20.tags=_22;
return _1a(_20);
},_1b);
},_1b);
...
},find_page:function(_25,_26,_27){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM contents WHERE (contents.name = ?) AND ( (contents.type = 'Page' ) ) LIMIT 1",[_25],function(tx,rs){
return _26(obj.parse_result(rs)[0]);
},function(tx,err){
return _27(err);
});
});
},find_by_category_id:function(_2e,_2f,_30){
this.find_all(_2e,_2f,_30);
},find_by_tag_id:function(_31,_32,_33){
this.find_all(_31,_32,_33);
},find_by_published_at:function(_34,_35,_36){
this.find_all(_34,_35,_36);
},search:function(_37,_38,_39){
this.find_all(_37,_38,_39);
},archives_box:function(_3a,_3b,_3c){
var obj=this;
db.transaction(function(tx){
...
_41[i]={year:row["year"],month:row["month"],count:row["count"]};
}
return _3b(_41);
},function(tx,err){
return _3c(err);
...
},page_box:function(_46,_47,_48){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM `contents` WHERE ( (`contents`.`type` = 'Page' ) )",[],function(tx,rs){
return _47(obj.parse_result(rs));
},function(tx,err){
return _48(err);
});
});
},create:function(_4f,_50,_51){
var _52=_4f.published_at_date.year+"-"+(_4f.published_at_date.month+1)+"-"+_4f.published_at_date.day+" "+_4f.published_at_time;
db.transaction(function(tx){
tx.executeSql("INSERT INTO contents (title,body,excerpt,published_at,created_at,updated_at,allow_pings,allow_comments,permalink,text_filter_id) VALUES(?,?,?,?,?,?,?,?,?,?)",[_4f.title,_4f.body,_4f.excerpt,_52,_52,_52,Number(_4f.allow_pings),Number(_4f.allow_comments),_4f.permalink,_4f.text_filter_id],function(tx,rs){
tx.executeSql("INSERT INTO sync (table_name,row_id,method) VALUES (?,?,?)",["contents",rs.insertId,"POST"],function(){
return _50(_4f);
},function(tx,err){
return _51(err);
});
...
var _5a=this.published_at.split(" ");
var _5b=_5a[0].split("-");
return _5b[1];
},published_at_year:function(){
var _5c=this.published_at.split(" ");
var _5d=_5c[0].split("-");
return _5d[0];
},published_at_mday:function(){
var _5e=this.published_at.split(" ");
var _5f=_5e[0].split("-");
return _5f[2];
},mark_search_term:function(_60){
jQuery.each(this,function(i,_62){
console.log("value: "+_62);
});
}});
;
include.setPath('models');
MainModel.extend("Category",{box:function(_1,_2,_3){
var _4=this;
db.transaction(function(tx){
...
},find_by_permalink:function(_a,_b,_c){
var _d=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM categories WHERE permalink = ?",[_a.category],function(tx,rs){
var _11=_d.parse_result(rs)[0];
_a.category=_11.id;
Article.find_by_category_id(_a,function(_12){
_11.articles=_12;
return _b(_11,_a);
},_c);
},function(tx,err){
...
},find_by_article_id:function(_15,_16,_17,_18){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM categories c1 JOIN categorizations c2 ON c1.id = c2.category_id WHERE c2.article_id=?",[_15],function(tx,rs){
return _17(obj.parse_result(rs),_16);
});
});
}},{});
;
include.setPath('models');
MainModel.extend("Tag",{box:function(_1,_2,_3){
var _4=this;
db.transaction(function(tx){
...
},find_by_name:function(_a,_b,_c){
var _d=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM tags WHERE name = ?",[_a.tag],function(tx,rs){
var tag=_d.parse_result(rs)[0];
_a.tag=tag.id;
Article.find_by_tag_id(_a,function(_12){
tag.articles=_12;
return _b(tag,_a);
},_c);
},function(tx,err){
...
},find_by_article_id:function(_15,_16,_17){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT tags.* FROM tags tags JOIN articles_tags at ON tags.id=at.tag_id JOIN contents contents on contents.id = at.article_id WHERE contents.id=?",[_15],function(tx,rs){
return _16(obj.parse_result(rs));
});
});
}},{font_size:function(_1c){
var _1d=0;
jQuery.each(_1c,function(i,_1f){
_1d+=parseInt(_1f.article_counter);
});
var _20=parseFloat(_1d)/parseFloat(_1c.length);
var _21=parseFloat(this.article_counter)/_20;
var _22=Math.min(Math.max(2/3,_21),2)*100;
return _22;
}});
;
include.setPath('models');
MainModel.extend("Sidebar",{find_all:function(_1,_2,_3){
var _4=this;
db.transaction(function(tx){
...
;
include.setPath('models');
MainModel.extend("Comment",{init:function(){
this._super();
...
tx.executeSql("INSERT INTO sync (table_name,row_id,method) VALUES (?,?,?)",["feedback",rs.insertId,"POST"],function(rs,tx){
var _a=new Date();
...
},find_by_article_id:function(_f,_10,_11){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT * FROM feedback WHERE article_id = ? and type = \"Comment\"",[_f],function(tx,rs){
return _10(obj.parse_result(rs));
});
});
},count:function(_16,_17){
var obj=this;
db.transaction(function(tx){
tx.executeSql("SELECT count(*) FROM feedback WHERE article_id = ? and type = \"Comment\"",[_16],function(tx,rs){
return _17(obj.parse_result(rs));
});
});
}},{});
;
...
var _3=new Worker("resources/sync.js");
...
$("#progressbar-status").width((_5.length*13)+"%");
$("#progressbar-status").html((_5.length*13)+"%");
if(_5.length==8){
db.transaction(function(tx){
...
;
include.setPath('controllers');
jQuery.Controller.extend("ArticleController",{onDocument:true},{list:function(_1,_2){
$(".section").html(this.view("init",{articles:_1,params:_2}));
},display_archive:function(_3,_4){
$(".section").html(this.view("init_archive",{articles:_3,params:_4}));
},show:function(_5){
$(".section").html(this.view("show",_5));
},"history.index subscribe":function(_6,_7){
var _8=(_7.page!=null&&_7.page>0)?_7.page:1;
Article.find_all({current_page:_8},this.callback("list"),this.callback(Notification.msg));
},"history.page.index subscribe":function(_9,_a){
var _b=_a.view;
Article.find_page(_b,this.callback("show"),this.callback(Notification.msg));
},"history.article.index subscribe":function(_c,_d){
var _e=_d.view;
var _f=(_d.page!=null&&_d.page>0)?_d.page:1;
Article.find_by_permalink(_e,this.callback("show"),this.callback(Notification.msg));
},"history.archive.index subscribe":function(_10,_11){
var _12=(_11.page!=null&&_11.page>0)?_11.page:1;
Article.find_by_published_at({current_page:_12,date:{month:_11.month,year:_11.year}},this.callback("display_archive"),this.callback(Notification.msg));
},"form submit":function(el,ev){
ev.preventDefault();
var _15=new Comment(el.formParams());
if(!_15.save()){
Notification.validation_errors(_15.errors);
}
},"comment.created subscribe":function(_16,_17){
Notification.msg("The comment has been saved");
$("#commentList").append(this.view("comment",_17));
...
$(".section").html(this.view("init",{category:_1,params:_2,}));
},"history.category.index subscribe":function(_3,_4){
var _5=_4.view;
var _6=(_4.page!=null&&_4.page>0)?_4.page:1;
Category.find_by_permalink({current_page:_6,category:_5},this.callback("show"),this.callback(Notification.msg));
},});
;
include.setPath('controllers');
jQuery.Controller.extend("TagController",{onDocument:true},{show:function(_1,_2){
$(".section").html(this.view("init",{tag:_1,params:_2,}));
},"history.tag.index subscribe":function(_3,_4){
var _5=_4.view;
var _6=(_4.page!=null&&_4.page>0)?_4.page:1;
Tag.find_by_name({current_page:_6,tag:_5},this.callback("show"),this.callback(Notification.msg));
},});
;
include.setPath('controllers');
jQuery.Controller.extend("SidebarController",{onDocument:true},{load:function(){
this.status_box();
this.search_box();
...
},categories_box:function(_2){
if(!$("#categories-box").length){
$("#sidebar").append($(document.createElement("section")).attr("id","categories-box"));
}
$("#categories-box").html(this.view("sidebar/category",{categories:_2}));
},tags_box:function(_3){
if(!$("#tags-box").length){
$("#sidebar").append($(document.createElement("section")).attr("id","tags-box"));
}
$("#tags-box").html(this.view("sidebar/tag",{tags:_3}));
},archives_box:function(_4){
if(!$("#archives-box").length){
$("#sidebar").append($(document.createElement("section")).attr("id","archives-box"));
}
$("#archives-box").html(this.view("sidebar/archive",{articles:_4}));
},page_box:function(_5){
if(!$("#page-box").length){
$("#sidebar").append($(document.createElement("section")).attr("id","page-box"));
}
$("#page-box").html(this.view("sidebar/page",{pages:_5}));
},status_box:function(){
if(!$("#status-box").length){
$("#sidebar").append($(document.createElement("section")).attr("id","status-box"));
}
var _6=localStorage["last_sync"];
$("#status-box").html(this.view("sidebar/status",{last_sync:_6}));
},update_server_status:function(){
var _7=new Worker("resources/server-status.js");
var el=$("#status");
var _9="";
_7.onmessage=function(_a){
if(_a.data==200){
_9="online";
}else{
_9="offline";
}
el.attr("class",_9+"-status");
if(el.html()!=_9){
Notification.msg("Server status: "+_9);
}
el.html(_9);
this.terminate();
return;
...
;
include.setPath('controllers');
jQuery.Controller.extend("NavigationController",{onDocument:true},{display_article_list:function(_1,_2){
$(".section").html(this.view("article/init",{articles:_1,params:_2,}));
},display_page:function(_3){
$(".section").html(this.view("article/show",_3));
},display_archive:function(_4){
$(".section").html(this.view("article/archive",{articles:_4,}));
},"history.menu-home.index subscribe":function(el,ev){
Article.find_all({current_page:1},this.callback("display_article_list"),this.callback(Notification.msg));
...
;
include.setPath('controllers');
jQuery.Controller.extend("SearchController",{onDocument:true},{display_articles:function(_1,_2){
$(".section").html(this.view("init",{articles:_1,params:_2}));
},perform_search:function(_3,_4){
if(_3.length>1){
window.location.hash="#search&page="+_4+"&q="+_3;
Article.search({current_page:_4,search:_3},this.callback("display_articles"),this.callback(Notification.msg));
}else{
Notification.msg("The length of a search term must be more than 1 character");
}
},"form submit":function(el,ev){
this.perform_search($("#q").val(),1);
},"history.search.index subscribe":function(_7,_8){
this.perform_search(_8.q,_8.page);
}});
;
include.setPath('controllers');
jQuery.Controller.extend("SynchronizationController",{onDocument:true},{load:function(){
...
_1.attr("href","/offline/index.html");
_1.html("reload a page with new data");
$("#sync-link").html(_1);
...
$("#sync-link").html(_3);
$("#progressbar").hide();
},"history.sync.index subscribe":function(_4,_5){
if(navigator.onLine){
this.sync_process();
}else{
Notification.msg("Sync error: you must be online to sync database.");
...
;
include.setPath('controllers');
jQuery.Controller.extend("AdminController",{onDocument:true},{"history.new-article.index subscribe":function(){
$(".section").html(this.view("article/new"));
},"#new-article submit":function(el,ev){
ev.preventDefault();
var _3=new Article(el.formParams());
if(!_3.save()){
Notification.validation_errors(_3.errors);
}
},"article.created subscribe":function(_4,_5){
Notification.msg("The article has been saved");
jQuery("#new-article input[type=text]").val("");
jQuery("#new-article textarea").val("");
},});
;
...
if(this.name==null){
_4.push("\n");
_4.push("        <h1 class=\"title\"><a href='#article&amp;view=");
_4.push((jQuery.View.Scanner.to_text(this.permalink)));
_4.push("'>");
...
_4.push("\n");
_4.push("                <a href=\"#tag&amp;view=");
_4.push((jQuery.View.Scanner.to_text(this.tags[i].name)));
_4.push("\" rel=\"tag\">");
...
_4.push("\n");
_4.push("            <span><a href='#category&amp;view=");
_4.push((jQuery.View.Scanner.to_text(this.categories[j].permalink)));
_4.push("'>");
_4.push((jQuery.View.Scanner.to_text(this.categories[j].name)));
_4.push("</a></span>\n");
_4.push("            ");
}
_4.push("\n");
...
_4.push((jQuery.View.Scanner.to_text(this.permalink+"&amp;title="+this.title)));
...
_4.push("        <li><a href=\"http://delicious.com/save\" onclick=\"javascript:void(0); return false;\" class=\"offline\"><img src='resources/themes/ims/images/social/delicious.png' alt=\"Delicious.com export\" /></a></li>\n");
_4.push("        <li><a href=\"'http://www.facebook.com/sharer.php?u='");
_4.push((jQuery.View.Scanner.to_text(this.permalink)));
_4.push("\" onclick=\"javascript:void(0); return false;\" class=\"offline\"><img src='resources/themes/ims/images/social/facebook.png' alt=\"Facebook.com export\" /></li>\n");
...
include.setPath('views/article');
(function($){
jQuery.View.PreCompiledFunction("../../views/article/new.ejs","views/article/new.ejs",function(_2,_3){
try{
with(_3){
with(_2){
var _4=[];
_4.push("<section id=\"admin\" class=\"new-article\">\n");
_4.push("<h1>New article</h1>\n");
_4.push("    <p>\n");
_4.push("    If you want to publish a new article you must save it locally and then sync your offline database with online service. You have\n");
_4.push("to sign in on <a href=\"http://typo.galileoagency.sk/admin\">http://typo.galileoagency.sk/admin</a> before syncing.\n");
_4.push("    </p>\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(form_tag("#new-article",{method:"post",id:"new-article"}))));
_4.push("\n");
_4.push("    <p>\n");
_4.push("        <label for=\"title\">Title</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(input_field_tag("title"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"body\">Body</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(text_area_tag("body"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"excerpt\">Excerpt</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(text_area_tag("excerpt"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label>Published at</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(date_tag("published_at_date"))));
_4.push("\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(time_tag("published_at_time"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"permalink\">Permalink</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(input_field_tag("permalink"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"text_filter_id\">Article filter</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(select_tag("text_filter_id","",[{text:"None",value:1},{text:"Markdown",value:2},{text:"SmartyPants",value:3},{text:"Markdown with SmartyPants",value:4},{text:"Textile",value:5}]))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"allow_comments\">Allow comments</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(check_box_tag("allow_comments","1"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        <label for=\"allow_pings\">Allow trackbacks</label>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(check_box_tag("allow_pings","1"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p>\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(input_field_tag("submit","save","submit"))));
_4.push("\n");
_4.push("    </p>\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(form_tag_end())));
_4.push("\n");
_4.push("</section>");
return _4.join("");
}
...
_4.push(" -\n");
_4.push("            <a href=\"#article&amp;view=");
_4.push((jQuery.View.Scanner.to_text(articles[i].permalink)));
_4.push("\" class=\"view\">");
_4.push((jQuery.View.Scanner.to_text(articles[i].title)));
_4.push("</a>\n");
_4.push("            ");
console.log(articles[i].categories);
_4.push("\n");
_4.push("            ");
if(articles[i].categories!=undefined&&articles[i].categories.length>0){
_4.push("\n");
_4.push("                posted in\n");
_4.push("                ");
...
_4.push("\n");
_4.push("                    <span><a href='#category&amp;view=");
_4.push((jQuery.View.Scanner.to_text(articles[i].categories[j].permalink)));
_4.push("'>");
_4.push((jQuery.View.Scanner.to_text(articles[i].categories[j].name)));
_4.push("</a></span>\n");
_4.push("                    ");
}
_4.push("\n");
...
_4.push("\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(pagination("#",params))));
_4.push("\n");
_4.push("\n");
return _4.join("");
}
...
_4.push("\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(pagination("#archive&amp;month="+params.date.month+"&amp;year="+params.date.year,params))));
return _4.join("");
}
}
}
...
for(var i=0;i<articles.length;i++){
_4.push("\n");
_4.push("        <li><a href=\"#archive&amp;month=");
_4.push((jQuery.View.Scanner.to_text(articles[i].month)));
_4.push("&amp;year=");
_4.push((jQuery.View.Scanner.to_text(articles[i].year)));
_4.push("\">");
_4.push((jQuery.View.Scanner.to_text(month_names[articles[i].month-1]+" "+articles[i].year)));
_4.push("</a></li>\n");
_4.push("        ");
}
_4.push("\n");
...
_4.push("\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(_5.toLocaleTimeString())));
_4.push("\n");
_4.push("        ");
_4.push((jQuery.View.Scanner.to_text(_5.toDateString())));
_4.push("\n");
_4.push("        ");
}
_4.push("\n");
_4.push("    </p>\n");
_4.push("    <p id=\"sync-link\"><a href=\"#sync\">synchronize</a></p>\n");
_4.push("    <p><a href=\"#new-article\">new article</a></p>\n");
_4.push("    <div id=\"progressbar\" class=\"hidden\"><div id=\"progressbar-wrapper\"><div id=\"progressbar-status\">&nbsp;</div></div></div>");
return _4.join("");
}
}
}
...
_4.push("    <div id=\"search\">\n");
_4.push("    <form action=\"#search\" method=\"get\" onsubmit=\"return false\">\n");
_4.push("    <input type=\"search\" id=\"q\" name=\"q\" placeholder=\"search blog\" value=\"\" size=\"15\">\n");
_4.push("    <input type='submit' value='Search'>\n");
_4.push("    </form>\n");
_4.push("    </div>");
return _4.join("");
}
...
var _4=[];
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(view("views/article/list",{articles:tag.articles}))));
_4.push("\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(pagination("#tag&amp;view="+tag.name,params))));
return _4.join("");
}
}
}
...
with(_2){
var _4=[];
_4.push("    <span style=\"font-size:");
_4.push((jQuery.View.Scanner.to_text(tag.font_size(tags))));
_4.push("%\"><a href=\"#tag&amp;view=");
_4.push((jQuery.View.Scanner.to_text(tag.name)));
_4.push("\" rel=\"tag\">");
...
;
include.setPath('views/search');
(function($){
jQuery.View.PreCompiledFunction("../../views/search/init.ejs","views/search/init.ejs",function(_2,_3){
try{
with(_3){
with(_2){
var _4=[];
_4.push("    <h1>Search result for \"");
_4.push((jQuery.View.Scanner.to_text(params.search)));
_4.push("\"</h1>\n");
_4.push("        ");
mark_search_term(articles,params.search);
_4.push("\n");
_4.push("    \n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(view("views/article/list",{articles:articles}))));
_4.push("\n");
_4.push("    ");
_4.push((jQuery.View.Scanner.to_text(pagination("#search",params))));
return _4.join("");
}
}
}
